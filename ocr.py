...
class App:
        ...
        if file is not None:
           ...
           if file_path:
              ...
              if file.type.startswith('image/'):
                  ...
                  return [{"content": ocr_text, "metadata": {}}]  # Return as a list of documents
              else:
   ...
   def node_parser(self):
      Settings.text_splitter = SentenceSplitter(chunk_size=2048, chunk_overlap=20)
      return Settings.text_splitter

   def llm_model(self):
      Settings.llm = Ollama(model="phi3:mini", request_timeout=100.0)
      return Settings.llm
